...
import (
	"chatgpt-qq/config"
	"chatgpt-qq/log"
	chatgptservices "chatgpt-qq/services/chatgpt-services"
	chatgptservices_proto "chatgpt-qq/services/chatgpt-services/proto"
...
func GenerateText(text string, useContext bool, userId, groupId, selfId int64) (string, error) {
	...
	ctx = defaultclient.AppendBearerTokenToContext(ctx, accessToken)
	in := &chatgptservices_proto.ChatCompletionReq{
		Id:              strconv.FormatInt(userId, 10),
		GroupId:         strconv.FormatInt(groupId, 10),
		Message:         text,
		Endpoint:        chatgptservices_proto.ChatEndpoint_QQ,
